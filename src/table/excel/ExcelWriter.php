...
namespace tobycroft\zbuilder\table\excel;

use tobycroft\zbuilder\table\excel\DocProps\App;
use tobycroft\zbuilder\table\excel\DocProps\Core;
use tobycroft\zbuilder\table\excel\Helpers\ExcelHelper;
use tobycroft\zbuilder\table\excel\Rels\Relationships;
use tobycroft\zbuilder\table\excel\Xl\SharedStrings;
use tobycroft\zbuilder\table\excel\Xl\Styles;
use tobycroft\zbuilder\table\excel\Xl\Workbook;
use tobycroft\zbuilder\table\excel\Xl\Worksheets\SheetXml;
...
class ExcelWriter
{
    ...
    {
        if (
            empty($sheetName) || ($this->sheets[$sheetName] instanceof Sheet &&
